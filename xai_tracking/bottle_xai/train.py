...
def main():
    ...
    trainset = CustomBottleDataset(img_dir='../aggregated_folder_bottle')
    ...
    testset = CustomBottleDataset(img_dir='../aggregated_folder_bottle', testset=True)
    ...
    print("loaded data...")
    CLASS_NAMES = ('broken_small', 'broken_large', 'contamination', 'good')
